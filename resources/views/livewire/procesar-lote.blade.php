                    ...
                    <table class="table table-bordered table-striped table-hover table-sm dataTable"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{{$item->deuda->direccion}}</td>
                                <td class="align-middle text-right">{{number_format($item->deuda->saldointerno,2,'.')}}
                                </td>
                                <td class="align-middle text-center">{{$item->deuda->rango}}</td>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-4 mb-2">
                            <button type="button" class="btn btn-primary btn-block" wire:click='guardar(0)'>GUARDAR <i
                                    class="fas fa-save"></i></button>
                        </div>
                        {{-- <div class="col-12 col-md-4">
                            <button type="button" class="btn btn-success btn-block" wire:click='guardar(1)'>GUARDAR -
                                FINALIZAR <i class="fas fa-save"></i></button>
                        </div> --}}
                    </div>
