...
return [
    ...
    */
    ...
    'logo' => '<b>COBRANZAS</b>',
    'logo_img' => 'images/template/icon72.png',
    'logo_img_class' => 'brand-image img-circle elevation-3',
    'logo_img_xl' => null,
    'logo_img_xl_class' => 'brand-image-xs',
    'logo_img_alt' => 'Cobranzas Logo',
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => false,
        'img' => [
            'path' => 'images/template/icon72.png',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'can' => 'estadocontactos.index',
                    'icon' => 'fas fa-fw fa-th-list'
                ],
                [
                    'text' => 'Metodos de Pago',
                    'route' => 'metodopagos.index',
                    'can' => 'metodopagos.index',
                    'icon' => 'fas fa-fw fa-th-list'
                ],
                [
                    'text' => 'Usuarios',
