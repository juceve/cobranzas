...
class Contacto extends Model
{
     ...
     */
    protected $fillable = ['lotedeuda_id', 'estadocontacto_id', 'gestiontipo_id', 'fechacontacto', 'horacontacto', 'nombrecontacto', 'proxcontacto', 'detalles', 'resultado', 'solicitudempresa', 'accionpropia', 'urlfoto', 'user_id', 'status'];
